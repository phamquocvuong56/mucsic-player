...
const MusicPlayer = () => {
	...
	useEffect(() => {
		...
		console.log('cd thumb ref: ', cdThumbRef.current)
		...
		console.log(
			'dashboardRef?.current?.offsetHeight: ',
			dashboardRef?.current?.offsetHeight
		);
		document.onscroll = function () {
			...
			console.log('on scroll: ', cdRef.current.style.width, cdRef.current.style.height)
		};
